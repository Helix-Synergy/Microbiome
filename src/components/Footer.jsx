...
const Footer = () => {
  ...
  const nav_links = [
    { name: "About", link:"/about-microbiome"},
    { name: "Executive Panel", link: "/executive-panel-members/" },
    { name: "Tracks", link: "/microbiome-conference-tracks/"},
    { name: "Orators", link: "/microbiome-orators"},
    { name: "Schedule", link: "/microbiome-event-schedule"},
  ...
  return (
    <div className="flex flex-col rounded-t-2xl bg-one/85 px-4 sm:px-6 md:px-12 py-8 md:py-10 text-white w-full">
      ...
      <div className="w-full md:w-1/4 flex flex-col mt-[10px] items-center md:items-start text-center md:text-left gap-4">
        <div className=" pt-10 p-4 rounded-xl">
          ...
          />
          <br />
        <p className="text-slate-200 text-sm px-4 md:px-8 mt-1">
